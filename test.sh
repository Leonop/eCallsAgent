...
#SBATCH --output=eCallsAgent/output/log_files/test.out      # Standard output and error log
#SBATCH --error=eCallsAgent/output/log_files/test.err       # Separate file for error logs
