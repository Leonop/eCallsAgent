...
MIN_DOCS_PER_TOPIC = 7 # Minimum number of documents per topic to use for distillation
MAX_DOCS_PER_TOPIC = 2000 # Maximum number of documents per topic to use for distillation
